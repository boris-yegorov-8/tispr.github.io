...
For instance at [tispr](http://tispr.com) builds are created after each commit and every week for internal testing, and weekly demo's for business & marketing departments.
