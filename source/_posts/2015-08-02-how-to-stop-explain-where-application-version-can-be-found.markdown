...
For instance at [tispr](http://tispr.com) develop builds after each commit, every week for internal testing, and weekly demo's for business & marketing departments.
